 ...
 * @return array
 */
function test_market_theme(array &$existing, $type, $theme, $path) {
  return array(
 ...
 */
// function test_market_page_alter(array &$page) {
//   global $user;
...
//   }
//   else {
//     $attributes = $disabled_popup ? array() : array('onclick' => 'javascript: test_market_popup_div("login-popup-box", true); return false;');
...
//  */
// function test_market_form_user_login_alter(array &$form, array &$form_state, $form_id) {
...
//       'onclick' => "javascript: test_market_popup_div('password-popup-box'); return false;",
//     );
...
//  * @see drupal_prepare_form()
//  */
// function test_market_form_user_pass_alter(array &$form, array &$form_state, $form_id) {
...
//  * @see drupal_prepare_form()
//  */
// function test_market_form_user_profile_form_alter(array &$form, array &$form_state, $form_id) {
...
//  * @see drupal_prepare_form()
//  */
// function test_market_form_alter(array &$form, array &$form_state, $form_id) {
//   global $user;
 ...
 */
function test_market_preprocess(&$variable){
 //print 'woohoo';
 // kpr($variable);
}
 ...
 */
function test_market_preprocess_block(array &$vars) {
  if (!$vars['block']->title) {
 ...
 */
function test_market_html_head_alter(array &$head_elements) {
  $head_elements['test_market_content_script_type'] = array(
    '#type' => 'html_tag',
    '#tag'  => 'meta',
    '#attributes' => array(
  ...
  $head_elements['test_market_content_style_type'] = array(
    '#type' => 'html_tag',
    '#tag'  => 'meta',
    '#attributes' => array(
  ...
  $head_elements['test_market_content_ie_compatibility9'] = array(
    '#type' => 'html_tag',
    '#tag'  => 'meta',
    '#attributes' => array(
  ...
  $head_elements['test_market_content_ie_compatibility8'] = array(
    '#type' => 'html_tag',
    '#tag'  => 'meta',
    '#attributes' => array(
      'http-equiv' => 'X-UA-Compatible',
