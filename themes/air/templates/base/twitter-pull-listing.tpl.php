...
<div class="tweets-pulled-listing">
  ...
  <!--span class="meta"><?php print t('SOCIAL MEDIA'); ?></span-->
  <?php if (!empty($title)): ?>
    <h2><?php print l($title, 'http://www.twitter.com/peytz'); ?></h2>
  <?php endif; ?>
  ...
  <?php if (is_array($tweets)): ?>
    ...
    <div class="actions"><?php print t('Follow us on <a href="http://twitter.com/peytz">Twitter</a>'); ?></div>
  <?php endif; ?>
</div>
